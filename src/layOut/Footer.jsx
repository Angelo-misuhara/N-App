    ...
    <>
      <div>
        <div className="flex flex-row p-4 mt-3 bottom-0 bg-gray-800 w-full justify-between" id="footerCContaioner">
          ...
          <div className="flex m-2" id="svfs">
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                  <a className="text-gray-500" href="https://www.facebook.com/angelo.yocor/" target="_blank" rel="noopener noreferrer">
            ...
            <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
                  ...
                  <a className="ml-3 text-gray-500" href="https://www.instagram.com/gel.hong/" target="_blank" rel="noopener noreferrer">
                    <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
            <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
            <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
                    </svg>
                  </a>
                  <a className="ml-3 text-gray-500" href=" https://www.linkedin.com/in/angelo-yocor-0885aa254/" target="_blank" rel="noopener noreferrer">
